...
```
	...
	CREATE TABLE `zhihu_answer_info` (
	  `id` varchar(32) NOT NULL DEFAULT '' COMMENT '知乎answer_id',
	  ...
	  `created_time` varchar(32) DEFAULT NULL COMMENT '知乎创建日期',
	  `url_token` varchar(64) DEFAULT NULL COMMENT '用户主页url',
	  `author_name` varchar(32) DEFAULT NULL COMMENT '用户名称',
