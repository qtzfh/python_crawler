...
def get_zhihu_question_info():
    select_sql = "select question_id from zhihu_question_info where read_num<1500000 AND follow_num <3000 and " \
                 "answer_num<400 and task_day='%s' and is_delete=1"%(getYesterday())
